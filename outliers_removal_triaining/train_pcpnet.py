...
from pcpnet import ResPCPNet, PCPNet
...
def parse_arguments():
    ...
    parser.add_argument(
        '--name', type=str, default='ResPCPNetOutliers', help='training run name')
    parser.add_argument(
        '--desc', type=str, default='', help='description')
    parser.add_argument('--indir', type=str, default='../data/outliers_training',
                        help='input folder (point clouds)')
    parser.add_argument('--outdir', type=str, default='../data/outliers_training_result',
...
#                        help='use same patches in each epoch, mainly for debugging')
    parser.add_argument('--identical_epochs', type=bool, default=False,
                        help='use same patches in each epoch, mainly for debugging')
...
#                        default=True, help='use feature spatial transformer')                     
    parser.add_argument('--use_point_stn', type=bool,
                        default=True, help='use point spatial transformer')
    parser.add_argument('--use_feat_stn', type=bool,
                        default=True, help='use feature spatial transformer')
...
def get_data(target_features, opt, train=True):
    ...
    if train:shapes_list_file = opt.trainset
    else:shapes_list_file = opt.testset
